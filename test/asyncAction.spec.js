...
const { success, failure, asThunk } = require('../src/index');
...
describe('asyncAction helpers', () => {
  describe('success', () => {
    ...
    describe('when an invalid action parameter is provided', () => {
      it('should throw an error', () => {
        function successCall() {
          success({});
        }
        successCall.should.throw(Error, 'action parameter is invalid. Please provide a string or an action object with the action type');
      });
    });
  });
  ...
  describe('failure', () => {
    ...
    describe('when an invalid action parameter is provided', () => {
      it('should throw an error', () => {
        ...
        failureCall.should.throw(Error, 'action parameter is invalid. Please provide a string or an action object with the action type');
      });
    });
  });
  ...
  describe('asThunk', () => {
    ...
    describe('when invoked with a dispatcher function', () => {
      ...
      describe('when the async action succeeds', () => {
        ...
        describe('and afterSuccess callback is provided', () => {
          ...
          it('should not dispatch the failure action if afterSuccess fails', async () => {
            ...
            try {
              await thunk(dispatch);
            } catch (err) { console.log('ignoring the exception'); }
      ...
      describe('when the async action fails', () => {
        let thunk; let actionCreator; let expectedAction;
